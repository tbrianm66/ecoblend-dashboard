...
import { Users, Search, X, Circle } from "lucide-react";
...
const ROLES = ["All Roles", "Studio Director", "Platform Admin", "Coach", "Founder"];
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: "#64748b" }}>
              All platform members, their assigned roles, and venture affiliations.
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl overflow-hidden border" style={{ borderColor: "#1e2d3d" }}>
            ...
            <div
              ...
              style={{
                gridTemplateColumns: "2.5rem 1fr 1fr 10rem 10rem 5rem",
                background: "#0a1520",
                color: "#334155",
            ...
            {(filtered as any[]).map((u: any, i: number) => {
              const cfg = roleCfg(u.systemRole);
