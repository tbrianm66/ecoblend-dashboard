...
const SAMPLE_RISKS: Risk[] = [
  { id: "r-1", ventureId: "v1", ventureName: "EcoBlend Materials", ventureColor: "#56A837", riskType: "technical", title: "Fibre consistency variability in hemp supply", description: "Natural fibre batches show 15-20% variation in tensile properties, impacting product consistency.", severity: 7, probability: 6, detectability: 4, rpn: 168, riskBand: "high", status: "mitigating", owner: "Dr. Sarah Chen", sourceModule: "R&D Hub" },
  { id: "r-2", ventureId: "v1", ventureName: "EcoBlend Materials", ventureColor: "#56A837", riskType: "market", title: "OEM adoption timeline longer than projected", description: "Automotive qualification cycles typically 18-36 months; current model assumes 12 months.", severity: 6, probability: 7, detectability: 5, rpn: 210, riskBand: "critical", status: "open", owner: "Brian", sourceModule: "Discovery" },
