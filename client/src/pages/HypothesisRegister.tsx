...
const SEED: Hypothesis[] = [
  {
    ...
    ventureId: "ecoblend",
    type: "value",
    persona: "Tier 1 automotive lightweighting engineers",
    behavior: "adopt a bio-composite for structural EV components",
    experiment: "running 3 paid pilot specs against an aluminium benchmark",
    metric: "≥20% weight saving at parity structural integrity",
    risk: "high",
    status: "testing",
    notes: "Pilot 1 hit 18% weight saving — promising but below threshold. Awaiting pilot 2 fatigue data.",
  },
  {
    id: "h2",
    ventureId: "bebus",
    type: "growth",
    persona: "urban commuters aged 22–35",
    behavior: "refer the service to a friend within 30 days",
    experiment: "a referral incentive shown to 500 trial riders",
    metric: "a viral coefficient (k) above 0.4",
    risk: "medium",
    status: "backlog",
    notes: "",
  },
  {
    ...
    ventureId: "tone",
    type: "value",
    persona: "independent music producers",
    behavior: "pay a premium for sustainable studio accessories",
    experiment: "a smoke-test landing page with 3 price points",
    metric: "a checkout click-through above 8%",
    risk: "medium",
    status: "validated",
    notes: "Landing page hit 11.2% CTR at the mid price. Willingness-to-pay confirmed; moving to a production run.",
  },
];
